package com.zup.Amazup.Componentes;
...
public class URIConstrutor {
    ...
    public URI criarURI(String path, String recurso){
        return UriComponentsBuilder.newInstance().scheme("http").host(host).port(porta).path(path + "/{recurso}")
                .buildAndExpand(recurso).toUri();
    }
